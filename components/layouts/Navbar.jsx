...
export default function Navbar() {
  ...
  const notifications = [
    ...
    { id: 3, message: 'Task completed: Project X', time: '2 hours ago' },
  ]

  return (
    <header className="bg-white border-b px-8 py-4 flex items-center justify-between">
      <div className="flex items-center gap-4">
        <h1 className="text-gray-700">Welcome! <span className="font-medium">Alex</span></h1>
      </div>
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="font-medium">Alex Robert</span>
